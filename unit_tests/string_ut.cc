...
constexpr auto
all_elememnts_equal_to( iterator first, iterator last, std::iter_value_t<iterator> ch ) noexcept
  {
  return last == std::find_if(first, last,
                              [ch](auto l) noexcept
                              { return l != ch;} );
  }
  ...
  "basic_string_insert"_test = [&]
    ...
    auto fn_tmpl =
      ...
      auto constexpr text_long{cast_fixed_string<char_type>("Lorem ipsum dolor sit amet, consectetur adipiscing elit."
        ...
        auto constexpr expected{cast_fixed_string<char_type>("1234Lorem ipsum dolor sit amet, consectetur adipiscing elit."
                                                       " Praesent ac enim tellus. Pellentesque nec lectus ligula, eu iaculis ante.")};
        constexpr_test( vs == expected.view());
        constexpr_test(is_null_termianted(vs));
        }
        ...
        constexpr_test(size(vs) == text_long.size() + text_short.size());
        auto constexpr expected{cast_fixed_string<char_type>("Lorem ipsum dolor sit amet, consectetur adipiscing elit."
        ...
        constexpr_test(size(vs) == text_long.size() + text_short.size());
        auto constexpr expected{cast_fixed_string<char_type>("12Lorem ipsum dolor sit amet, consectetur adipiscing elit."
      ...
      auto constexpr text_long2{cast_fixed_string<char_type>("Praesent ac enim tellus. Pellentesque nec lectus ligula, eu iaculis ante.")};
        ...
        auto constexpr expected{cast_fixed_string<char_type>("Lore"
                                                       "Praesent ac enim tellus. Pellentesque nec lectus ligula, eu iaculis ante."
  ...
  "basic_string_append"_test = [&]
    ...
    auto fn_tmpl =
      ...
      auto constexpr text_long{cast_fixed_string<char_type>("Lorem ipsum dolor sit amet, consectetur adipiscing elit."
        ...
        auto constexpr expected{cast_fixed_string<char_type>("1234"
