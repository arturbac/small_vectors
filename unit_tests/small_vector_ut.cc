...
using consteval_test_type_list = metatests::type_list<uint8_t, uint16_t, uint32_t, uint64_t,struct_3_byte,struct_5_byte>;
using constexpr_test_type_list = metatests::type_list<uint8_t, uint16_t, uint32_t, uint64_t,struct_3_byte,struct_5_byte,
                                                      non_trivial,non_trivial_ptr,non_trivial_ptr_except_copy>;
}
...
using boost::ut::neq;
  ...
  "test_small_vector_constr"_test = [&result]
    {
    auto fn_tmpl =
      []<typename value_type, typename size_type>
        ( value_type const *, size_type const * ) -> metatests::test_result
      {
      test_result tr;
        {
...
//---------------------------------------------------------------------------------------------------------------------
  ...
  "test_small_vector_emplace_back_tmpl"_test = [&result]
    ...
    auto fn_tmpl =
        []<typename value_type, typename size_type,
          typename szreq_ic>
          ( value_type const *, size_type const *, szreq_ic  ) -> metatests::test_result
      {
    ...
    auto fn_size =
        [fn_tmpl]<typename value_type, typename size_type>
          ( value_type const * t, size_type const * u ) -> metatests::test_result
      {
    ...
    using consteval_test_type_list_2 = metatests::type_list<uint8_t, uint16_t, uint32_t, uint64_t,
                                                            non_trivial_ptr, non_trivial_ptr_except, non_trivial_ptr_except_copy>;
...
//---------------------------------------------------------------------------------------------------------------------
  ...
  "test_small_vector_erase_at_end"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      constexpr size_type second_growth = coll::detail::growth( coll::detail::growth( capacity_req, size_type(1)), size_type(1));
      static_assert(second_growth+1u < test_values.size() );
...
//---------------------------------------------------------------------------------------------------------------------
  "test_small_vector_pop_back"_test = [&result]
    {
    auto test_small_vector_pop_back_tmpl =
        []<typename value_type, typename size_type,
          typename szreq_ic>
          ( value_type const *, size_type const *, szreq_ic  ) -> metatests::test_result
      {
    ...
    auto test_small_vector_pop_back_sz =
        [test_small_vector_pop_back_tmpl]<typename value_type, typename size_type>
          ( value_type const * t, size_type const * u ) -> metatests::test_result
      {
      using size_req = std::integral_constant<size_type, coll::at_least<value_type>(size_type(4))>;
      ...
      //size_type capacity_req = coll::at_least<value_type>(size_type(4))
    auto test_small_vector_pop_back_0 =
        [test_small_vector_pop_back_tmpl]<typename value_type, typename size_type>
          ( value_type const *t, size_type const * u) -> metatests::test_result
      {
      using size_req = std::integral_constant<size_type, 0u>;
    ...
    result |= run_consteval_test_dual<consteval_test_type_list_1,constexpr_size_type_traits_list>(test_small_vector_pop_back_sz);
    result |= run_consteval_test_dual<consteval_test_type_list_2,constexpr_size_type_traits_list>(test_small_vector_pop_back_0);

    result |= run_constexpr_test_dual<consteval_test_type_list_2,constexpr_size_type_traits_list>(test_small_vector_pop_back_sz);
    result |= run_constexpr_test_dual<consteval_test_type_list_2,constexpr_size_type_traits_list>(test_small_vector_pop_back_0);
  ...
  "test_small_vector_insert"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      static_assert(second_growth+1u < test_values.size() );
        ...
        tr |= constexpr_test(size(v) == expected.size())
          | constexpr_test(equal(v,expected))
          | constexpr_test(v.active_storage() == dynamic );
        }
...
//---------------------------------------------------------------------------------------------------------------------
  ...
  "test_small_vector_insert_except"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      require_throw<std::runtime_error>( [&v,&throwing](){insert(v, v.begin(), std::make_move_iterator(begin(throwing)),
                                  std::make_move_iterator(end(throwing)) );} );
      v.front().set_value(128);
      require_throw<std::runtime_error>( [&v,&test_values](){insert(v, v.begin(), begin(test_values), std::next(begin(test_values),10) );});
...
//           size_type capacity_req2 = capacity_req>
  ...
  "test_small_vector_copy_constr"_test = [&result]
    ...
    auto fn_tmpl =
        []<typename value_type, typename size_type,
          typename szreq_ic, typename szreq_ic2>
          ( value_type const *, size_type const *, szreq_ic, szreq_ic2  ) -> metatests::test_result
      {
      constexpr size_type capacity_req = szreq_ic::value;
      ...
      if constexpr(capacity_req !=0u)
        ...
        tr |= constexpr_test(size(cp) == expected.size())
  ...
  "test_small_vector_copy_assignment"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      if constexpr(expected_istorage(capacity_req)==buffered)
        ...
        tr |= constexpr_test(size(cp) == redzone.size())
...
//---------------------------------------------------------------------------------------------------------------------
  ...
  "test_at_max_size"_test = [&result]
    {
    auto fn_tmpl =
        []<typename value_type, typename szreq_ic>
          ( value_type const *, szreq_ic  ) -> metatests::test_result
      {
    ...
    auto fn_size =
        [fn_tmpl]<typename value_type>
          ( value_type const * t ) -> metatests::test_result
      {
  ...
  "test_small_vector_resize"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      clear(vec);
        ...
        tr |= constexpr_test(size(vec) == 125)
          | constexpr_test(equal(vec,expected));
        }
        {
        resize(vec,25);
  ...
  "test_small_vector_shrink_to_fit"_test = [&result]
    ...
    auto fn_tmpl =
      ...
      constexpr size_type first_growth = coll::detail::growth( capacity_req, size_type(1));
        ...
        tr |= constexpr_test(size(vec) == first_growth)
