...
using test_types = metatests::type_list<
...
namespace concepts
  {
  struct tag_with_hash { static constexpr bool enable_hash_specialization = true; };
  struct tag_with_hash_neg { static constexpr bool enable_hash_specialization = false; };
  struct tag_empty{};
  ...
  struct tag_with_arithemtic { static constexpr bool enable_arithemtic = true; };
  struct tag_with_arithemtic_neg { static constexpr bool enable_arithemtic = false; };
  ...
  struct tag_with_comparison { static constexpr bool enable_comparison = true; };
  struct tag_with_comparison_neg { static constexpr bool enable_comparison = false; };
  ...
  struct tag_with_binary_operators { static constexpr bool enable_binary_operators = true; };
  struct tag_with_binary_operators_neg { static constexpr bool enable_binary_operators = false; };
