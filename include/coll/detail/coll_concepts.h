...
namespace coll::detail
  ...
  inline constexpr bool is_nothrow_move_constr_and_constr_v = std::is_nothrow_constructible_v<T,Args...>
                                                           && std::is_nothrow_move_constructible_v<T>;

  template< class T, class... Args >
  inline constexpr bool is_nothrow_copy_constr_and_constr_v = std::is_nothrow_constructible_v<T,Args...>
