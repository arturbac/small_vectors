...
) noexcept(is_nothrow_move_constr_and_constr_v<typename vector_type::value_type, detail::iterator_value_type_t<source_iterator>>)
  {
  constexpr bool use_nothrow = is_nothrow_move_constr_and_constr_v<
    typename vector_type::value_type,
