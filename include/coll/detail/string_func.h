...
namespace coll::detail::string
{
  ...
  struct growth_t
    ...
    [[nodiscard]] small_vector_static_call_operator
    constexpr size_type operator()(size_type new_elements )
  ...
  struct cond_null_terminate_t
    ...
    inline constexpr void operator()( char_type * data )
        small_vector_static_call_operator_const noexcept
      {
    ...
    small_vector_static_call_operator
    inline constexpr void operator()( char_type * data, size_type new_size )
        small_vector_static_call_operator_const noexcept
      {
      if constexpr (null_terminate_string)
  ...
  struct clear_t
    {
    template<coll::detail::detail_concepts::vector_storage vector_storage>
    small_vector_static_call_operator
    inline constexpr void operator()(vector_storage & storage)
        small_vector_static_call_operator_const noexcept
      {
      storage.size_ = 0u;
  ...
  struct uninitialized_construct_t
    ...
    [[nodiscard]] small_vector_static_call_operator
    inline constexpr auto operator()( typename vector_storage::size_type sz, lambda const & uninitialized_fn )
        small_vector_static_call_operator_const
        -> vector_storage
      {
  ...
  struct uninitialized_assign_t
    {
    template<coll::detail::detail_concepts::vector_storage vector_storage, typename lambda>
    small_vector_static_call_operator
    inline constexpr void
    operator()( vector_storage & storage, typename vector_storage::size_type sz, lambda const & uninitialized_fn  )
        small_vector_static_call_operator_const
      {
      using char_type = typename vector_storage::value_type;
      using size_type = typename vector_storage::size_type;
  ...
  struct swap_t
    ...
    template<coll::detail::detail_concepts::vector_storage vector_storage>
    small_vector_static_call_operator
    inline constexpr void operator()( vector_storage & lstorage, vector_storage & rstorage)
        small_vector_static_call_operator_const noexcept
      {
  ...
  struct copy_construct_t
    ...
    [[nodiscard]] small_vector_static_call_operator
    inline constexpr auto operator()( iterator first, iterator last )
        small_vector_static_call_operator_const
        -> vector_storage
      {
      using size_type = typename vector_storage::size_type;
      return uninitialized_construct<vector_storage>(static_cast<size_type>(std::ranges::distance(first,last)),
  ...
  struct assign_copy_t
    {
    template<coll::detail::detail_concepts::vector_storage vector_storage, concepts::forward_iterator iterator>
    small_vector_static_call_operator
    inline constexpr void operator()( vector_storage & storage, iterator first, iterator last )
        small_vector_static_call_operator_const
      {
      using size_type = typename vector_storage::size_type;
      uninitialized_assign(storage, static_cast<size_type>(std::ranges::distance(first,last)),
                           [&first, &last](auto * data) noexcept
                           {
                           return uninitialized_copy(first, last, data );
                           });
  ...
  struct value_construct_t
    ...
    operator()( typename vector_storage::size_type sz )
        small_vector_static_call_operator_const
        -> vector_storage
      {
  ...
  struct fill_assign_t
    ...
    small_vector_static_call_operator
    inline constexpr void
    operator()( vector_storage & storage, typename vector_storage::size_type sz, typename vector_storage::value_type ch )
        small_vector_static_call_operator_const
      {
  ...
  struct reserve_t
    ...
    small_vector_static_call_operator
    inline constexpr void
    operator()( vector_storage & storage, typename vector_storage::size_type req_capacity )
        small_vector_static_call_operator_const
      {
      using char_type = typename vector_storage::value_type;
      using size_type = typename vector_storage::size_type;
  ...
  struct resize_and_overwrite_t
    {
    template<coll::detail::detail_concepts::vector_storage vector_storage, typename Operation>
    small_vector_static_call_operator
    inline constexpr void operator()( vector_storage & storage,
  ...
  struct resize_t
    ...
    small_vector_static_call_operator
    inline constexpr void
    operator()( vector_storage & storage, typename vector_storage::size_type sz )
        small_vector_static_call_operator_const
      {
      using char_type = typename vector_storage::value_type;
      using size_type = typename vector_storage::size_type;
  ...
  struct append_fill_t
    ...
    inline constexpr void operator()( vector_storage & storage,
      ...
      resize_and_overwrite(storage, new_size, 
                             [old_size = storage.size_, new_size, ch](char_type * data, size_type /*buff_cap*/)
                               noexcept -> size_type
                             {
  ...
  struct append_copy_t
    ...
    inline constexpr void operator()( vector_storage & storage, iterator first, iterator last )
      ...
      size_type new_size { static_cast<size_type>(storage.size_ + count) };
      resize_and_overwrite(storage, new_size, 
                             [old_size = storage.size_, new_size,first,last](char_type * data, size_type /*buff_cap*/)
                               noexcept -> size_type
                             {
  ...
  struct push_back_t
    ...
    template<coll::detail::detail_concepts::vector_storage vector_storage>
    small_vector_static_call_operator
    inline constexpr void operator()( vector_storage & storage, typename vector_storage::value_type ch )
        small_vector_static_call_operator_const
      {
  ...
  struct erase_t
    ...
    small_vector_static_call_operator
    inline constexpr void 
    operator()( vector_storage & storage,
