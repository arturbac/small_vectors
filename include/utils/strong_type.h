...
constexpr strong_type<value_type, tag> const & operator++(strong_type<value_type, tag> & v) noexcept
  {
  ++v.ref_value();
  return v;
  }
...
template<typename value_type, concepts::tag_arithemtic tag>
constexpr strong_type<value_type, tag> operator++(strong_type<value_type, tag> & v, int) noexcept
  {
